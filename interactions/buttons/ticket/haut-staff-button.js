...
module.exports = {
    name: "haut-staff-button",
    async runInteraction(client, interaction) {
        await interaction.guild.channels.create("Haut-Staff " + interaction.user, {
        ...
        permissionOverwrites: [
          ...
          {
            id: (process.env.ROLE_HAUT_STAFF),
            allow: ["VIEW_CHANNEL"]
          }
        ]
      }).then(async channel => {
        const embed = new MessageEmbed()
          .setTitle('**Support haut-staff Flow Life**')
          .setColor('6d6ee8')
          ...
          .setFooter('Support haut-staff Flow Life')
          .setTimestamp()
