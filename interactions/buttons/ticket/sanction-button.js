...
module.exports = {
    name: "sanction-button",
    async runInteraction(client, interaction) {
        await interaction.guild.channels.create("Sanction " + interaction.user, {
        ...
        const embed = new MessageEmbed()
          .setTitle('**Support sanction Flow Life**')
          .setColor('6d6ee8')
          ...
          .setFooter('Support sanction Flow Life')
          .setTimestamp()
